...
// Routes Warehouse Keeper (Magasinier)
Route::post('/warehouse/v1/login', [App\Http\Controllers\Api\Mobile\WarehouseKeeperController::class, 'login'])->name('warehouse.api.v1.login');
Route::middleware('auth:sanctum')->group(function () {
    Route::get('/warehouse/v1/warehouses', [App\Http\Controllers\Api\Mobile\WarehouseKeeperController::class, 'getWarehouses'])->name('warehouse.api.v1.warehouses');
    Route::get('/warehouse/v1/warehouses/{id}/sheet', [App\Http\Controllers\Api\Mobile\WarehouseKeeperController::class, 'getStockSheet'])->name('warehouse.api.v1.sheet');
    Route::post('/warehouse/v1/movements', [App\Http\Controllers\Api\Mobile\WarehouseKeeperController::class, 'storeMovement'])->name('warehouse.api.v1.movements.store');
    Route::post('/warehouse/v1/sync', [App\Http\Controllers\Api\Mobile\WarehouseKeeperController::class, 'syncMovements'])->name('warehouse.api.v1.sync');
    Route::get('/warehouse/v1/stats', [App\Http\Controllers\Api\Mobile\WarehouseKeeperController::class, 'getStats'])->name('warehouse.api.v1.stats');

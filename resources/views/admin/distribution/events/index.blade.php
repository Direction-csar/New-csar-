                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('admin.distribution.events.destroy', $event->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Supprimer cet événement et TOUS ses plannings, bénéficiaires et tickets ?')">
                                    @csrf @method('DELETE')

...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-plus-circle me-2"></i>Nouvelle question FAQ</h1>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select name="category" class="form-control" required>
                                <option value="usager" {{ old('category') == 'usager' ? 'selected' : '' }}>Usager</option>
                                <option value="bailleur" {{ old('category') == 'bailleur' ? 'selected' : '' }}>Bailleur</option>

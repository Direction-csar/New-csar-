{{-- Assistant CSAR - Posez vos questions --}}
...
/* Zone d'écriture - poser une question */
.csar-chatbot-write {
...
/* Message utilisateur (question posée) */
...
(function() {
    ...
    /* Mots-clés pour associer les questions écrites aux réponses */
    const keywordMap = [

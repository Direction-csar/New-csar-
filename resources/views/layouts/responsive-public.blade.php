...
<div class="public-layout">
        ...
        <div class="header-container">
            <div class="header-content">
                ...
                <nav class="desktop-nav">
                    ...
                    <a href="{{ route('partners.index', app()->getLocale()) }}" class="nav-item {{ request()->routeIs('partners.*') ? 'active' : '' }}">
                        Partenaires
                    </a>
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <nav class="mobile-nav">
            ...
            <a href="{{ route('partners.index', app()->getLocale()) }}" class="mobile-nav-item {{ request()->routeIs('partners.*') ? 'active' : '' }}">
                Partenaires
            </a>

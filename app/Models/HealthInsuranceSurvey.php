    ...
    public static function questionLabels(): array
    {
        return [
            ...
            'q4_soins_response' => [
                ...
                'options' => ['largement' => 'Oui, largement', 'avec_limites' => 'Oui, avec des limites', 'non' => 'Non', 'pas_concerne' => 'Pas concerné'],
            ],
            'q5_panier_soins' => [
            ...
            'q9_coassurance' => [
                ...
                'options' => ['tres_satisfait' => 'Très satisfait', 'satisfait' => 'Satisfait', 'pas_satisfait' => 'Pas satisfait', 'autre' => 'Autre', 'pas_concerne' => 'Pas concerné'],
            ],
            'q10_reseau_soins' => [
